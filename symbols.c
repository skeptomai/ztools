...
#else
static int get_type_from_name(tname) char *tname;
#endif
{
	int ch = tname[0];
...
int print_attribute_name(unsigned long attr_names_base,
						 int attr_no)
#else
int print_attribute_name(attr_names_base, attr_no) unsigned long attr_names_base;
int attr_no;
#endif
{
	if (attr_names_base)
...
int print_property_name(unsigned long property_names_base,
						int prop_no)
#else
int print_property_name(property_names_base, prop_no) unsigned long property_names_base;
int prop_no;
#endif
{
...
int print_local_name(unsigned long start_of_routine,
					 int local_no)
#else
int print_local_name(start_of_routine, local_no) unsigned long start_of_routine;
int local_no;
#endif
{
	start_of_routine;
...
int print_global_name(unsigned long start_of_routine,
					  int global_no)
#else
int print_global_name(start_of_routine, global_no) unsigned long start_of_routine;
int global_no;
#endif
{
	start_of_routine;
